...
mkdir -p grants-engine data/grants applications

cat > grants-engine/grant-acquisition-engine.js <<'JS'
const fs=require("fs");
...
cat > grants-engine/grant-api.js <<'JS'
...
echo "Add this to server-watson.js if missing:"
echo 'app.use("/api/grants",require("./grants-engine/grant-api"));'

pm2 restart nia
pm2 save

echo "✅ NIA Grant Acquisition Engine online"
